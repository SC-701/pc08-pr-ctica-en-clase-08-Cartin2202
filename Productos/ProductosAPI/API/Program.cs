...
builder.Services.AddHttpClient("ServicioPrecioCrc");
...
builder.Services.AddScoped<IPrecioCrcServicio, PrecioCrcServicio>();
builder.Services.AddScoped<IConfiguracion, Configuracion>();
builder.Services.AddScoped<IPrecioCrcRegla, PrecioCrcRegla>();
