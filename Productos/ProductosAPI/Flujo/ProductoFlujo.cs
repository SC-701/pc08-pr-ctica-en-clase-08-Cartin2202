...
namespace Flujo
{
    public class ProductoFlujo : IProductoFlujo
    {
        ...
        private readonly IPrecioCrcRegla _precioCrcRegla;


        public ProductoFlujo(IProductoDA productoDA, IPrecioCrcRegla precioCrcRegla)
        {
            _productoDA = productoDA;
            _precioCrcRegla = precioCrcRegla;
        ...
        public async Task<ProductoDetalle> Obtener(Guid Id)
        {
            ...
            var precioCrc = await _precioCrcRegla.ObtenerTipoCambio(new ProductoResponse
            {
                Id = producto.Id,
